...
public class PugResource {
    ...
    public Response createOrUpdatePug( @PathParam("id") String id,
                                       Pug pug ) throws URISyntaxException {
        PugsRepository.createOrUpdate( pug );
        return Response.created( new URI( "/pugs/" + id ) ).build();
    }
    ...
    public Response create( Pug pug ) throws URISyntaxException {
        Pug newPug = PugsRepository.createOrUpdate( pug );
